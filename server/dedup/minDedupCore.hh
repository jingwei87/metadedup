...
public:
     ...
     */
    bool
    firstStageDedup(const int &userID, unsigned char *shareMDBuffer, const int &shareMDSize, bool *intraUserDupStatList,
                    int &numOfShares, int &sentShareDataSize);
     ...
     */
    bool restoreShareFile(const int &userID, const std::string &fullFileName, const int &versionNumber, int socketFD,
                          CryptoPrimitive *cryptoObj);
