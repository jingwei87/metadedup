...
private:
     ...
     */
    bool crsssDecoding(unsigned char *shareBuffer, int *kShareIDList, int shareSize, int secretSize,
                       unsigned char *secretBuffer, unsigned char *keyBuffer);
     ...
     * @return - a boolean value that indicates if the decoding succeeds
     */
    bool caontRSOldDecoding(unsigned char *shareBuffer, int *kShareIDList, int shareSize, int secretSize,
                            unsigned char *secretBuffer, unsigned char *keyBuffer);
     ...
     * @return - a boolean value that indicates if the decoding succeeds
     */
    bool caontRSDecoding(unsigned char *shareBuffer, int *kShareIDList, int shareSize, int secretSize,
                         unsigned char *secretBuffer, unsigned char *keyBuffer);
...
public:
     ...
     * @return - a boolean value that indicates if the decoding succeeds
     */
    bool decoding(unsigned char *shareBuffer, int *kShareIDList, int shareSize, int secretSize,
                  unsigned char *secretBuffer, unsigned char *keyBuffer);
};
